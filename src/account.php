...
//$result = mysqli_query($con,"SELECT * FROM quiz ORDER BY date DESC") or die('Error');
//echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
//'<b>Select Stream</b><br><br>
//<button type="submit" name="GCP">GCP</button><br><br>
//<button type="submit" name="AWS">AWS</button><br><br>
//<button type="submit" name="Azzure">Azzure</button>';
...
if($sn!=1)
{
echo'<button type="submit" class="btn btn-primary" name="previous" id="previous"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>&nbsp;Previous</button>
';
}
echo '<button type="submit" class="btn btn-primary" name="next" id="next">&nbsp;Next<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></button></form></div>';
